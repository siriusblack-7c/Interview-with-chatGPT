...
export default function JobDescriptionGenerator({
    ...
    }, [jobTitle, industry, companyName, companySize, experienceLevel, keySkills, onJobDescriptionGenerated, onClose]);
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="Large (1001-5000 employees)">Large (1001-5000 employees)</option>
